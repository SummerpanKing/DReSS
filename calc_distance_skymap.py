...
import pickle
from auxgeo.dataset.skymap import SkymapDatasetTrain
...
dataset = SkymapDatasetTrain(data_folder=r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/SkyMAP",
                            same_area=SAME_AREA)
...
for idx in train_sat_ids:
    ...
    _, _, long, lat = idx2sat[idx][:-4].split('_')
...
print("Saving...")  
with open(r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/SkyMAP/gps_dict_same.pkl", "wb") as f:
...
print("Saving...")  
with open(r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/SkyMAP/gps_dict_cross.pkl", "wb") as f:
    pickle.dump(near_neighbors, f)
