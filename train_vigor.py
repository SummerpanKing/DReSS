...
from auxgeo.dataset.vigor import VigorDatasetEval, VigorDatasetTrain
...
class Configuration:
    ...
    gps_dict_path: str = r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/VIGOR/gps_dict_same.pkl"  # gps_dict_cross.pkl | gps_dict_same.pkl
    ...
    # Dataset
    data_folder = r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/VIGOR"
