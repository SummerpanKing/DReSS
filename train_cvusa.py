...
from auxgeo.dataset.cvusa import CVUSADatasetEval, CVUSADatasetTrain
...
from auxgeo.evaluate.cvusa_and_cvact import evaluate, calc_sim
...
class Configuration:
    ...
    gps_dict_path: str = "/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVUSA/gps_dict.pkl"  # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVUSA"
