...
df_train = pd.read_csv(r'/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVUSA/splits/train-19zl.csv', header=None)
...
df_gps = pd.read_csv(r'/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVUSA/all.csv', header=None)
...
print("Saving...")
with open(r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVUSA/gps_dict.pkl", "wb") as f:
