...
import pickle
from auxgeo.dataset.vigor import VigorDatasetTrain
...
dataset = VigorDatasetTrain(data_folder="/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/VIGOR",
                            same_area=SAME_AREA)
...
print("Saving...")  
with open("/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/VIGOR/gps_dict_same.pkl", "wb") as f:
...
print("Saving...")  
with open("/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/VIGOR/gps_dict_cross.pkl", "wb") as f:
    pickle.dump(near_neighbors, f)   
