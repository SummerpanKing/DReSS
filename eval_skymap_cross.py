...
from auxgeo.dataset.skymap import SkymapDatasetEval
...
class Configuration:
    ...
    # Dataset
    data_folder = "./data/SkyMAP"
    same_area: bool = False  # True: same | False: cross
    ground_cutting = 0  # cut ground upper and lower

    # Checkpoint to start from
    checkpoint_start = 'pretrained/vigor_cross/convnext_base.fb_in22k_ft_in1k_384/weights.pth'

    # Savepath for model checkpoints
    model_path: str = "./checkpoints/skymap_cross"
