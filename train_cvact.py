...
from auxgeo.dataset.cvact import CVACTDatasetTrain, CVACTDatasetEval, CVACTDatasetTest
...
class Configuration:
    ...
    gps_dict_path: str = r"/media/xiapanwang/主数据盘/xiapanwang/Codes/python/New_Geolocalization/0_Datasets/CVACT/gps_dict.pkl"  # path to pre-computed distances
    ...
    model_path: str = "./checkpoints/cvact"
...
if __name__ == '__main__':
    ...
    new_hight = round((832 / 1664) * new_width)
